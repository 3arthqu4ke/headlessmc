...
class DefaultParser implements Parser {
    ...
    @Override
    public CompletingParsedLine parse(final String line, final int cursor, ParseContext context) {
     ...
     */
    public class ArgumentList implements CompletingParsedLine, ParsedLine {
