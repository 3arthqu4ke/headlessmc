...
interface Parser {
    ...
    CompletingParsedLine parse(String line, int cursor, ParseContext context) throws SyntaxError;

    default CompletingParsedLine parse(String line, int cursor) throws SyntaxError {
