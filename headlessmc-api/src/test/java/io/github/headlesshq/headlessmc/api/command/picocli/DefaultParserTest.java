...
public class DefaultParserTest {
    ...
    public void testEscapedWord() {
        ...
        CompletingParsedLine line = parser.parse("foo second\\ param \"quoted param\"", 15);
        assertNotNull(line);
    ...
    public void testQuotedWord() {
        DefaultParser parser = new DefaultParser();
        CompletingParsedLine line = parser.parse("foo second\\ param \"quoted param\"", 20);
        assertNotNull(line);
        assertNotNull(line.words());
        assertEquals("foo second\\ param \"quoted param\"", line.line());
    ...
    public void testSplitLine() {
        DefaultParser parser = new DefaultParser();
        CompletingParsedLine line = parser.parse("foo second\\ param \"quoted param\"", 0, Parser.ParseContext.SPLIT_LINE);
        assertNotNull(line);
        assertNotNull(line.words());
