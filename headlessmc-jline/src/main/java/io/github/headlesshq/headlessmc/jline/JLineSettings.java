...
public class JLineSettings extends Module {
    public final SettingGroup group = root.group("hmc.jline", "JLine configuration");

    public final SettingKey<Boolean> enabled = group.setting(Boolean.class)
            .withName("hmc.jline.enabled")
            .withDescription("Enables/Disables JLine support.")
            .withValue(true)
            .build();

    public final SettingKey<Boolean> propagateEnabled = group.setting(Boolean.class)
    ...
    public final SettingKey<String> providers = group.setting(String.class)
    ...
    public final SettingKey<String> readPrefix = group.setting(String.class)
    ...
    public final SettingKey<@Nullable String> type = group.setting(String.class)
            .withName("hmc.jline.type")
            .withAlias("hmc.args.type") // legacy name
            .withDescription("A prefix to display when reading with the JLine Command Line.")
            .nullable();

    public final SettingKey<Boolean> dumb = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> forceNotDumb = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> dumbWhenNoConsole = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> noDeprecationWarning = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> bracketedPaste = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> jlineIn = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> jlineOut = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> ffm = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> jansi = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> jna = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> jni = group.setting(Boolean.class)
    ...
    public final SettingKey<Boolean> exec = group.setting(Boolean.class)
    ...
    public final SettingKey<@Nullable Boolean> system = group.setting(Boolean.class)
            .withName("hmc.jline.system")
            .withAlias("hmc.args.system") // legacy name
            .withDescription("Enables System Terminal support.")
            .nullable();

    public final SettingKey<Boolean> progressBar = group.setting(Boolean.class)
    ...
    public final SettingKey<@Nullable String> progressBarStyle = group.setting(String.class)
