...
public class VersionSpecificModRepositoryTest {
    ...
    public void testVersionSpecificModRepository() throws MalformedURLException {
        URL url = new URL("https://github.com/3arthqu4ke/mc-runtime-test/releases/download/");
        ...
        URL expected = new URL("https://github.com/3arthqu4ke/mc-runtime-test/releases/download/2.2.0/mc-runtime-test-1.12.2-2.2.0-lexforge-release.jar");
